...
@section('content')
    ...
    <table class="table table-hover table-responsive mx-2 mt-4">
        ...
        @foreach($patrimonios as $patrimonio)
            <tr>
                ...
                <td> 
                <a class="btn btn-primary rounded-circle" href="{{route('patrimonio.edit', ['patrimonio_id' => $patrimonio->id])}}">
                    <img src="{{URL::asset('/assets/edit_icon.svg')}}" width="15px" alt="Icon de edição"> 
                </a>    
                <a class="btn btn-danger rounded-circle" href="{{route('patrimonio.delete', ['patrimonio_id' => $patrimonio->id])}}">
    ...
    <div class="d-flex" style="max-width:600px">
        <a class="w-100 btn btn-primary" style="margin-right: 10px" href="{{route('patrimonio.create')}}">Cadastrar item</a>
