@extends('layouts.app')
@section('content')
@include('layouts.components.header', ['page_title' => 'Editar Movimentação de Patrimônio', 'back' => true])
    ...
    <form method="POST" action="{{route('movimento.update')}}" enctype="multipart/form-data">
        ...
        <div style="margin-top: 30px" class="d-flex justify-content-between">
            ...
            <a style="width: 150px" class="btn btn-danger" href="{{route('movimento.delete', ['movimento_id' => $movimento->id])}}"> Deletar </a>
        </div>
    </form>
@endsection
