    ...
    <ul class="navbar-nav px-6" style="width: 240px;">
        @auth
            @if(\Illuminate\Support\Facades\Auth::user()->tipo_usuario_id == 1)
                ...
                @include('layouts.components.navitem', ['route' => __('Classificações'), 'route_link' => route('classificacao.index'), 'route_route_name' => 'classificacao', 'icon_name' => 'classificacao.svg'])
